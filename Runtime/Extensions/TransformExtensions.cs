...
namespace Jenga {
    public static class TransformExtensions {
        ...
        private static void GetTRS(
            ...
            rotationMatrix = rotationMatrix * new Matrix4x4 { 
                m00 = 1f / scale.x, m11 = 1f / scale.y, 
                m22 = 1f / scale.z, m33 = 1 
            };
        ...
        public static void SetFromLocalMatrix(
            this Transform transform, Matrix4x4 matrix, bool isLeftHanded, 
            bool isZup, float scaleFactor
        ) {
        ...
        public static Matrix4x4 GetLocalMatrix(
            this Transform transform, bool isLeftHanded, 
            bool isZup, float scaleFactor
        ) {
