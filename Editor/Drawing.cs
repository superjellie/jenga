...
namespace Jenga {
    ...
    public static class Drawing
    {
        ...
        public static void DrawLine(Vector2 pointA, Vector2 pointB, Color color, float width, bool antiAlias, Texture2D texture = null)
        {
            ...
            float dx = (pointB.x - pointA.x) * EditorGUIUtility.pixelsPerPoint;
            float dy = (pointB.y - pointA.y) * EditorGUIUtility.pixelsPerPoint;
            ...
            m.m00 = dx; m.m01 = -wdx; m.m03 = pointA.x + 0.5f * wdx;
            m.m10 = dy; m.m11 = wdy;  m.m13 = pointA.y - 0.5f * wdy;

            // var matrix = 
            //     Matrix4x4.Scale(new Vector3(len, width, 1f))
            //     * Matrix4x4.Rotate(Mathf.Atan2(dy, dx))
            //     * Matrix4x4.Translate(pointA);
            ...
            Graphics.DrawTexture(
                lineRect, texture != null ? texture : tex, 
                new Rect(0f, 0f, len / (2f * width), 1f), 
                0, 0, 0, 0, color, mat
            );
            //Replaced by:
